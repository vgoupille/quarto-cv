...
#show: doc => cv(
  ...
  sidebar-sections: (
      ...
      title: "Languages",
            items: (
                              (name: "\[Language 1\]", value: "\[Level\]", ),
                                        (name: "\[Language 2\]", value: "\[Level\]", ),
                        ),
            
            style: (
        "text-size": eval("10.5pt"),
      ...
      title: "Interests",
            items: (
                              (name: "\[Interest 1\]",  subitems: ("\[Sub-interest 1\]","\[Sub-interest 2\]","\[Sub-interest 3\]",),),
                                        (name: "\[Interest 2\]",  subitems: ("\[Sub-interest 1\]","\[Sub-interest 2\]",),),
                                        (name: "\[Interest 3\]",  ),
                        ),
      ...
      title: "IT Skills",
            items: (
                              (category: "Languages", items: "\[Language 1, Language 2\]"),
                                        (category: "Tools", items: "\[Tool 1, Tool 2\]"),
                        ),
...
[
#strong[Objective: \[Your professional goal\]]
...
<yyyy---yyyy-degree-title>
#emph[\[Institution, City\] | \[Grade/Honours\]]

\[Description of the program content.\]

== YYYY - YYYY | \[Degree Title\]
<yyyy---yyyy-degree-title-1>
#emph[\[Institution, City\] | \[Grade/Honours\]]

\[Description of the program content.\]

== YYYY - YYYY | \[Degree Title\]
<yyyy---yyyy-degree-title-2>
#emph[\[Institution, City\] | \[Grade/Honours\]]
...
<yyyy-experience-title-x-days>
#emph[\[Dr Name (Specialty), City\]]

== YYYY | \[Experience Title\] (X days)
<yyyy-experience-title-x-days-1>
#emph[\[Institution, City\]]
