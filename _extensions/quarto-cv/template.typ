...
#let cv(
  ...
  let make-sidebar(auto-spacing) = {
    ...
    let render-typed-item(item-type, style) = {
      ...
      let icon-map = (
        phone: $cv-icons.phone$,
        email: $cv-icons.email$,
        birthdate: $cv-icons.birthdate$,
        city: $cv-icons.city$,
        nationality: $cv-icons.nationality$,
        permit: $cv-icons.permit$,
        website: $cv-icons.website$,
        linkedin: $cv-icons.linkedin$,
        github: $cv-icons.github$,
      )
