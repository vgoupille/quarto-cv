...
#show: doc => cv(
  ...
  sidebar: (
    ...
    "email": "alex.chen\@example.com".replace("\@", "@"),
    "birthdate": "22/07/1998",
    "city": "Lyon, France",
    "nationality": "Franco-Chinese",
    "website": "https:\/\/alexchen.dev".replace("\/", "/"),
    "website-display": "alexchen.dev".replace("\@", "@"),
    "permit": "Driving License B",
    "linkedin": "https:\/\/linkedin.com/in/alex-chen".replace("\/", "/"),
    "linkedin-display": "\@alex-chen".replace("\@", "@"),
    "github": "https:\/\/github.com/achen".replace("\/", "/"),
    "github-display": "\@achen".replace("\@", "@"),
  ),
  ...
  sidebar-sections: (
      ...
      id: "photo",
        ...
        "section-after": eval("1em"),
        "photo-size": eval("70pt"),
        "photo-radius": eval("0%"),
        "photo-border": true,
        "photo-border-width": eval("2pt"),
        "section-before": eval("0em"),
      ...
      title: "Contact",
        ...
        "title-size": eval("11pt"),
        
        
        
        "icon-color": rgb("\#25EBDB".replace("\#", "#")),
        
        "item-after": eval("3em"),
        "section-after": eval("0em"),
      ...
      title: "Languages",
            items: (
                              (name: "French", value: "Native", ),
                                        ...
                                        (name: "Mandarin", value: "B1 - Intermediate", ),
                                        (name: "Japanese", value: "A2 - Basic", ),
                        ),
      ...
      title: "Programming",
            items: (
                              (category: "Data Science", items: "Python, R, SQL, Julia"),
                                        (category: "ML Frameworks", items: "TensorFlow, PyTorch, scikit-learn"),
                                        (category: "Tools", items: "Git, Docker, Jupyter, Quarto"),
                                        (category: "Cloud", items: "AWS, GCP, Azure ML"),
                                        (type: "birthdate"),
                        ),
            
            style: (
        "text-size": eval("8pt"),
        "title-size": eval("12pt"),
        "title-font": "Courier New",
        "text-font": "Courier New",
        "icon-size": eval("5pt"),
        "icon-color": rgb("\#52F916".replace("\#", "#")),
        ...
        "category-color": rgb("\#f97316".replace("\#", "#")),
        
        "item-color": rgb("\#FF0000".replace("\#", "#")),
      ...
      title: "Research Interests",
            items: (
                              (name: "AI & Ethics",  subitems: ("Fairness in ML","Bias mitigation",),),
                                        (name: "Computer Vision",  subitems: ("Object detection","Image classification",),),
                                        (name: "Time Series",  subitems: ("Forecasting","Anomaly detection",),),
                        ),
            
            style: (
        "text-size": eval("3pt"),
        "title-size": eval("30pt"),
        
        
        
        "icon-color": rgb("\#a855f7".replace("\#", "#")),
        
        
        "section-after": eval("10em"),
  ...
  sidebar-defaults: (
    ...
    "item-after": eval("0.6em"),
    "section-after": eval("2em"),
  ...
  layout-config: (
           "sidebar-width": eval("40%"), 
       "main-width": eval("2fr"), 
       "gutter": eval("3cm"), 
       "sidebar-bg": rgb("\#06080A".replace("\#", "#")), 
       "main-bg": rgb("\#EEE6E6".replace("\#", "#")), 
              "margins": (
            "top": eval("0cm"), 
            "bottom": eval("4cm"), 
            "left": eval("1cm"), 
  ...
  theme: (
     ...
     "text-font": "Inter", 
          "sidebar": (
          "title-color": rgb("\#AF1E42".replace("\#", "#")), 
          "text-color": rgb("\#05C525".replace("\#", "#")), 
          "accent-color": rgb("\#7169BF".replace("\#", "#")), 
          "link-color": rgb("\#E1EB25".replace("\#", "#")), 
          "icon-color": rgb("\#2563eb".replace("\#", "#")), 
          "photo-border-color": rgb("\#EB8B25".replace("\#", "#")), 
         
         
      ),
      "main": (
          "title-color": rgb("\#B8628C".replace("\#", "#")), 
          "subtitle-color": rgb("\#DEC404".replace("\#", "#")), 
          "text-color": rgb("\#1f2937".replace("\#", "#")), 
  ...
  cv-header: (
    ...
    "objective": "Passionate about building fair and interpretable machine learning systems. Expertise in deep learning, computer vision, and time series forecasting. Seeking opportunities to work on high-impact problems in AI ethics and responsible AI.",
    "name-color": "\#A72222",
    "name-size": "6pt",
    "title-color": "\#053398",
    "title-size": "24pt",
...
<fair-vision-bias-detection-in-computer-vision-models>
#emph[Published in IEEE CVPR Workshop 2024]

Developed interpretable framework for detecting and mitigating gender/age bias in facial recognition systems across different demographic groups.

=== IEEE CVPR Workshop, Vancouver
<ieee-cvpr-workshop-vancouver>
== 2023 | TimeNet: Temporal Attention for Long-Sequence Forecasting
<timenet-temporal-attention-for-long-sequence-forecasting>
#emph[Open-source library --- #link("https://github.com/achen/timenet")[github.com/achen/timenet]]

Implemented attention-based architecture for multi-step time series forecasting. Outperformed state-of-the-art baselines (MAPE: 8.2% vs.~12.1%). 1200+ GitHub stars, active community contributions.
...
<research-visualizations-multi-column-layout>
#grid(
columns: (50fr, 50fr), gutter: 1em, rows: 1,
  rect(stroke: none, width: 100%)[
=== Model Performance Comparison
<model-performance-comparison>
#block[
#box(image("advanced-example_files/figure-typst/unnamed-chunk-1-1.svg"))
...
#block[
#figure([
#box(image("advanced-example_files/figure-typst/fig-cars-1.svg"))
...
#table(
  columns: 2,
  align: (auto,auto,),
  table.header([Certification], [Year],),
  table.hline(),
...
body: 
[
Use custom per-section fonts with #NormalTok("text-font"); and #NormalTok("title-font"); to create visual hierarchy in your sidebar! See table → #ref(<tbl-second>, supplement: [Table])
